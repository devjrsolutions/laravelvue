    ...
    export default {
        ...
        methods: {
            save() {
                ...
                axios.put('/system/permissions/' + self.propPermissionId,payload).then(function(response) {
            ...
            loadPermission(cb) {
                ...
                axios.get('/system/permissions/' + self.propPermissionId).then(function(response) {
