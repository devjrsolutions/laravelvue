    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                axios.put('/system/users/'+self.propUserId,payload).then(function(response) {
            ...
            loadUser(cb) {
                ...
                axios.get('/system/users/' + self.propUserId).then(function(response) {
            ...
            loadPermissions(cb) {
                ...
                axios.get('/system/permissions',{params: params}).then(function(response) {
            ...
            loadGroups(cb) {
                ...
                axios.get('/system/groups',{params: params}).then(function(response) {
