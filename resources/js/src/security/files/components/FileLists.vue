    ...
    export default {
        ...
        methods: {
            ...
            trash(file) {
                ...
                self.$store.commit('showDialog',{
                    ...
                    okCb: ()=>{
                        ...
                        axios.delete('/system/files/' + file.id).then(function(response) {
            ...
            loadFileGroups(cb) {
                ...
                axios.get('/system/file-groups',{params: params}).then(function(response) {
            ...
            loadFiles(cb) {
                ...
                axios.get('/system/files',{params: params}).then(function(response) {
