    ...
    export default {
        ...
        methods: {
            save() {
                ...
                axios.put('/system/file-groups/' + self.propFileGroupId,payload).then(function(response) {
            ...
            loadFileGroup(cb) {
                ...
                axios.get('/system/file-groups/' + self.propFileGroupId).then(function(response) {
