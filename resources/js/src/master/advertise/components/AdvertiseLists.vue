        ...
        <v-card class="pt-3">
            <div class="d-flex flex-row">
                <div class="flex-grow-1 pa-2">
                    <v-btn @click="$router.push({name:'advertise.create'})" class="primary lighten-1" dark>
                        Tambah Advertise
                        <v-icon right dark>add</v-icon>
                    </v-btn>
                </div>
                <div>
                    <v-btn @click="$router.push({name:'advertise.excel'})" class="success lighten-1" dark>
                        Download File
                    ...
                    <tr v-for="item in items" :key="item.id">
                        <td>
                            <div class="text-center">
                                <v-btn @click="$router.push({name:'advertise.edit',params:{id: item.id}})" class="ma-2" outlined fab small color="info">
    ...
    export default {
        ...
        methods: {
            trash(advertise) {
                ...
                self.$store.commit('showDialog',{
                    ...
                    okCb: ()=>{
                        ...
                        axios.delete('/system/advertise/' + advertise.id).then(function(response) {
            ...
            loadAdvertise(cb) {
                ...
                axios.get('/system/advertise',{params: params}).then(function(response) {
