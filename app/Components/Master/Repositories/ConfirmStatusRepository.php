...
class ConfirmStatusRepository extends BaseRepository
{
    public function __construct(ConfirmStatus $model)
    {
     ...
     */
    public function listConfirmStatus($params)
    {
    ...
    public function delete(int $id)
    {
        ...
        {
            /** @var User $User */
            $ConfirmStatus = $this->model->find($id);
