...
namespace App\Components\Sales\Repositories;
...
class InteraksiRepository extends BaseRepository
{
    public function __construct(Interaksi $model)
    {
     ...
     */
    public function listInteraksi($params)
    {
